...
(function () {
    ...
    bridge.executeCustomNativeCall = function (args) {
        var command = args.shift();
    ...
    mraid.videoPlay = function () {
        bridge.executeCustomNativeCall(['videoAdStarted']);
    };

    mraid.videoPause = function () {
        bridge.executeCustomNativeCall(['videoAdPaused']);
    };

    mraid.videoCompleted = function (value) {
        var args = ['videoAdCompleted','shouldClose', value];
        bridge.executeCustomNativeCall(args);
    };
    
    mraid.videoProgress = function (value) {
        var args = ['videoAdProgress','progress', value];
        bridge.executeCustomNativeCall(args);
    };
    ...
    // Custom Call for ConsoliAds SDK
