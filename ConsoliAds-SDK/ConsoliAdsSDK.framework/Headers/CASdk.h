...
- (BOOL)initWithAppKey:(NSString*)userSignature andDelegate:(id<ConsoliadsSdkInitializationDelegate>)adelegate userConsent:(BOOL)consent devMode:(BOOL)isDevMode;
